...
- **Multi-Language Support** - TypeScript, JavaScript, Python, PHP, Go, Rust, Java, Kotlin, and Storybook
...
- Test framework (Jest, Vitest, Storybook, pytest, PHPUnit, Go 1.24+, Rust with cargo/cargo-nextest, or JUnit 5)
